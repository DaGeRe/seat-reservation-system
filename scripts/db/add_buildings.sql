...
insert into mydatabase.buildings(name, town, address, used, ordering, remark) values ('Hauptstelle Dresden,  Bautzner Str.19a/b', 'Dresden', '', TRUE, 1, '');
...
insert into mydatabase.floors(name, name_Of_Img, building_id, ordering, remark) values ('Erdgeschoss','Erdgeschoss.png', (select building_id from buildings where name = 'Hauptstelle Dresden,  Bautzner Str.19a/b' limit 1), 0, '');
insert into mydatabase.floors(name, name_Of_Img, building_id, ordering, remark) values ('1. Obergeschoss','1. Obergeschoss.png', (select building_id from buildings where name = 'Hauptstelle Dresden,  Bautzner Str.19a/b' limit 1), 1, '');
