...
(6,'11:00:00','\0','2024-09-11','14:00:00',NULL,7,5,6),
(7,'09:00:00','\0','2024-09-14','13:00:00',NULL,7,5,6),
...
(4,'Ground','Büro_02 Erdgeschoss','enable','Normal',7,70),
(5,'First','Büro_02 Obergeschoss','enable','Normal',11,18),
...
INSERT INTO `users` (`id`, `admin`, `email`, `name`, `password`, `surname`, `visibility`) VALUES (2,'','richard.lehmann@mail.com','Richard','$2a$10$ZR1ETLX3QwfAVWCzc515buXggo41e1zYrcdd.YA3SCzJyrjuzSfEu','Lehmann',''),
...
-- Dump completed on 2024-09-14 20:16:37
-- MariaDB dump 10.19-11.3.2-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: mydatabase
-- ------------------------------------------------------
...
-- Dump completed on 2024-09-15 10:53:22
