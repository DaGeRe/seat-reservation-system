...
(26,'10:00:00','\0','2024-09-14','14:30:00',NULL,14,7,3),
(27,'14:00:00','\0','2024-09-17','21:30:00',NULL,14,7,3),
(28,'10:00:00','\0','2024-09-16','13:00:00',NULL,1,1,9),
(29,'07:00:00','\0','2024-10-03','16:00:00',NULL,3,1,9),
(31,'08:00:00','\0','2024-10-03','11:00:00',NULL,20,13,9),
(32,'09:00:00','\0','2024-10-02','12:30:00',NULL,18,11,9),
(33,'09:30:00','\0','2024-10-15','15:00:00',NULL,3,1,9);
...
INSERT INTO `desks` (`desk_id`, `equipment`, `room_id`) VALUES (1,'with equipment',1),
(2,'with equipment',2),
(3,'with equipment',1),
(4,'with equipment',1),
(5,'with equipment',1),
...
(11,'with equipment',1),
(12,'with equipment',1),
(14,'without equipment',7),
(18,'with equipment',11),
(19,'with equipment',12),
(20,'without equipment',13);
...
(11,'Ground','Büro023','enable','Normal',37,71),
(12,'Ground','Büro010','enable','Normal',12,7),
(13,'Ground','Büro033','enable','Silence',76,32);
...
-- Dump completed on 2024-10-21  6:13:01
-- MariaDB dump 10.19-11.3.2-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: mydatabase
-- ------------------------------------------------------
...
(1,'06:00:00','\0','2024-09-28','09:00:00',NULL,1,1,3),
(2,'12:30:00','\0','2024-09-14','15:00:00',NULL,8,3,3),
(3,'16:00:00','\0','2024-09-14','18:00:00',NULL,8,3,3),
(4,'06:30:00','\0','2024-09-14','11:00:00',NULL,8,3,6),
(8,'10:30:00','\0','2024-09-14','14:00:00',NULL,9,3,6),
...
(32,'09:00:00','\0','2024-10-02','12:30:00',NULL,18,11,9),
(33,'09:30:00','\0','2024-10-15','15:00:00',NULL,3,1,9),
(34,'09:30:00','\0','2024-10-21','14:00:00',NULL,21,6,6);
/*!40000 ALTER TABLE `bookings` ENABLE KEYS */;
UNLOCK TABLES;
...
(18,'with equipment',11,NULL),
(19,'with equipment',12,NULL),
(20,'without equipment',13,NULL),
(21,'with equipment',6,'Schreibtisch 1 ');
/*!40000 ALTER TABLE `desks` ENABLE KEYS */;
UNLOCK TABLES;
...
(1,'Ground','Konferenzraum_01 Erdgeschoss','enable','Normal',59,70),
(2,'First','Büro_01 Obergeschoss','enable','Normal',60,86),
(3,'Ground','Büro_01 Erdgeschoss','enable','Normal',83,89),
(6,'Ground','Wechselarbeitsplat_01 Erdgeschoss','enable','Normal',10,89),
(7,'Ground','Standardbüro_01 Erdgeschoss','enable','Normal',56,88),
...
-- Dump completed on 2024-10-21  7:14:09
-- MariaDB dump 10.19-11.3.2-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: mydatabase
-- ------------------------------------------------------
...
(33,'09:30:00','\0','2024-10-15','15:00:00',NULL,3,1,9),
(34,'09:30:00','\0','2024-10-21','14:00:00',NULL,21,6,6),
(35,'07:30:00','\0','2024-10-21','13:00:00',NULL,19,12,2),
(36,'14:30:00','\0','2024-10-21','17:00:00',NULL,21,6,2);
/*!40000 ALTER TABLE `bookings` ENABLE KEYS */;
UNLOCK TABLES;
...
(14,'without equipment',7,NULL),
(18,'with equipment',11,NULL),
(19,'with equipment',12,'Test'),
(20,'without equipment',13,NULL),
(21,'with equipment',6,'Schreibtisch 1 '),
(22,'with equipment',12,'d');
/*!40000 ALTER TABLE `desks` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `rooms` VALUES
(1,'Ground','Konferenzraum_01 Erdgeschoss','enable','Normal',59,70),
(2,'First','Büro_01 Obergeschoss Test','enable','Normal',60,86),
(3,'Ground','Büro_01 Erdgeschoss','enable','Normal',83,89),
(6,'Ground','Wechselarbeitsplat_01 Erdgeschoss','enable','Silence',10,89),
(7,'Ground','Standardbüro_01 Erdgeschoss','enable','Normal',56,88),
(11,'Ground','Büro023','enable','Normal',37,71),
(12,'Ground','Büro010','enable','Normal',12,7),
(13,'Ground','Büro033','enable','Silence',76,32);
...
-- Dump completed on 2024-10-21 14:43:06
-- MariaDB dump 10.19-11.3.2-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: mydatabase
-- ------------------------------------------------------
...
-- Dump completed on 2024-10-21 14:56:46
