...
import {Table, Tooltip, Button, TableBody, TableCell, TableContainer,Typography, TableHead, TableRow, Paper, FormControl,Select, MenuItem, InputLabel, TextField, Box } from '@mui/material';
...
import HtmlTooltip from '../FloorImage/HtmlTooltip';
            ...
            <div className='mb-content'>
                ...
                <div className='mb-content-container'>
                    <Box sx={{ flexGrow: 1, padding: '10px', maxWidth: '800px' }}>
                        <>
                        <Tooltip title={i18n.language === 'de' ? 'Die Email-Adresse. Bei mehreren durch Kommata getrennt.' : 'The email address. In case of more than one, comma seperated.'}>
                          <TextField
                            id='emailsString'
                            variant='outlined'
                            fullWidth
                        ...
                        <Tooltip title={i18n.language === 'de' ? 'Gruppen in denen Sie Mitglied sind. Kann zur Vorauswahl der E-Mail-Adressen verwendet werden.' : 'Groups you are member of. Can be used to autofill email addresses.'}>
                          <FormControl id='groupSelectionForm' required={false} fullWidth>
                            <InputLabel id='groupSelectionFormlabel'>
                              {i18n.language === 'de' ? 'Grupen' : 'Groups'}
                            </InputLabel>
                            <Select
                        ...
                        <TableContainer component={Paper} sx={{
                          ...
                          <Typography variant='h6' component='div' sx={{ padding: 2 }}>
                            {i18n.language === 'de' ? `Buchungen der ausgewählten Kollegen zum ${new Date(date).toISOString().split('T')[0]} ` : `Bookings of colleagues on ${new Date(date).toISOString().split('T')[0]}`}
                          </Typography>
